        ...
        <ul class="nav nav-tabs row d-flex">
          ...
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="100">
            <a class="nav-link" data-toggle="tab" href="#tab-2">
              ...
              <h4 class="d-none d-lg-block">COVID 19 HOTSPOTS </h4>
            </a>
          </li>
          ...
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="300">
            <a class="nav-link" data-toggle="tab" href="#tab-4">
              ...
              <h4 class="d-none d-lg-block">COVID PUNJAB UPDATES</h4>
            </a>
          </li>
        </ul>
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <p class="font-italic">
                  The following data provides data on testing done at centers in Kerala for the treatment & diagnosis of COVID-19.
                </p>
                <ul>
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <iframe src="https://www.google.co.in/maps/d/embed?mid=1bIFK-Wyv4uLS325qq8JvuBsO-wqr3Rjf" width="640" height="480"></iframe>
              </div>
            </div>
...
<div class="container table-responsive">
  ...
  <h1 style="text-align: center;">DAILY-RECORDS OF TESTING IN PUNJAB</h1>
