    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container"><br><br><br>
         <img class="animated fadeInDown" src="img/aa.png" >
        </div>
      </div>
        ...
        <div class="container">
            ...
            <div class="row">
             ...
             <img  class="responsive" src="img/logo.png"></a>
                <p class="d-flex">
                  <span class="ion-ios-location icon mr-5" style="color: red"></span>
                  <span>Saidabad, Hyderabad, Telangana,India</span>
                </p>

                <p class="d-flex">
                  <span class="ion-ios-telephone icon mr-5" style="color: red"></span>
                  <span>+91 98666325691</span>
                </p>

                <p class="d-flex">
                  <span class="ion-android-mail icon mr-5" style="color: red"></span>
