      ...
      <div class="container">
        ...
        <div class="tab-content" data-aos="fade-up">
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> <n2 >PUNJAB CONFIRMED<h2>
                  <n2 id="dc"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>PUNJAB RECOVERED<h2>
                  <n2 id="dr"><h2></li>
                  <li><i class="ri-check-double-line"></i>  <n2>PUNJAB DEATHS<h2>
                  <n2 id="dd"><h2></li>
                </ul>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>Clinics  & Testing centers in PUNJAB</h3>
                
                <p class="font-italic">
                  List of government approved testing centers
                <ul>
                  <li><i class="ri-check-double-line"></i>Guru Gobind Singh Medical College and Hospital, Sadiq Rd, Kotakpura, GGS Medical Hospital, Faridkot, Punjab 151203</li>
                  <li><i class="ri-check-double-line"></i> Govt. Medical College, Amritsar</li>
                  <li><i class="ri-check-double-line"></i>Govt. Medical College,Patiala</li>
                  <li><i class="ri-check-double-line"></i> Department of Microbiology Dayanand Medical College & Hospital , Tagore Nagar, Civil Lines, Ludhiana, Punjab 141001 </li>
                  <li><i class="ri-check-double-line"></i> Tuli Diagnostic Centre,Majitha Rd, opposite G.N.D. Hospital, Opposite Guru Nanak Dev Hospital, Gopal Nagar, Amritsar, Punjab 143001</li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
...
Array.prototype.sum = function (prop) {
    ...
    var DelhiConfirmed = covid_data[27].districtData.sum("confirmed");
    document.getElementById("dc").innerHTML = DelhiConfirmed
    var DelhiDeceased = covid_data[27].districtData.sum("deceased");
    document.getElementById("dd").innerHTML = DelhiDeceased
        var DelhiRecovered = covid_data[27].districtData.sum("deceased");
        ...
        <div class="container-fluid">
          <div class="row" data-aos="fade">
            ...
            <div class="container" style="position: center;">
              <CENTER>
<img class="responsive" src="img/punjab/pp.png">
</CENTER>
</div>
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                    <?php
                                  $query = "SELECT * FROM healthcare WHERE state='punjab'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN PUNJAB</h1>
  <br><br>
  <CENTER>
  <div ><a href="https://www.medicineindia.org/hospitals-in-state/punjab">
             <button id="mapsbtn">SEARCH CENTERS</button></a>
            </div></CENTER>
<!-- <center>
